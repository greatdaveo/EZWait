      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.section}>
            ...
            <TextInput placeholder="Enter your business name" placeholderTextColor="#BABABA" style={styles.textInput} />
            <Text style={styles.subSectionText}>Email</Text>
            <TextInput placeholder="Enter your email" placeholderTextColor="#BABABA" style={styles.textInput} />
            <Text style={styles.subSectionText}>Number</Text>
            <TextInput placeholder="Enter your Number" placeholderTextColor="#BABABA" style={styles.textInput} />
          </View>
          ...
          <TouchableOpacity style={styles.sectionItem}>
            ...
            <TextInput placeholder="Enter your location" placeholderTextColor="#BABABA" style={styles.textInput} />
          </View>
        </View>
        ...
        <Modal visible={modalVisible} transparent={true} animationType="slide">
          <View style={styles.modalContainer}>
            ...
            <View style={styles.buttonContainerCover}>
              ...
              <TouchableOpacity style={styles.saveBtn} onPress={uploadSampleWorkImg}>
